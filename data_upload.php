            ...
            <div>
                <table class='table_preview'>
                    ...
                    while(($row = fgetcsv($handle)) !== false):
                        ...
                        <!-- プレビューテーブル -->
                        <tr>
                            <td><input placeholder="" type='text' class='band_preview' name='preview_band' value="<?= htmlspecialchars($row[$key_band],ENT_QUOTES,'UTF-8')?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_vocal' value="<?= $band[$n]['vocal']?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_guiter_1' value="<?= $band[$n]['guiter_1']?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_guiter_2' value="<?= $band[$n]['guiter_2']?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_bass' value="<?= $band[$n]['bass']?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_drum' value="<?= $band[$n]['drum']?>"></td>
                            <td><input placeholder="" type='text' class='text_preview' name='preview_keybord' value="<?= $band[$n]['keybord']?>"></td>
                            <td><input placeholder="" type='number' class='songs_preview' name='preview_songs' value="<?= $band[$n]['songs']?>"></td>
                        </tr>
                        <?php $n++;
                        // var_dump($band)
                        ?>
